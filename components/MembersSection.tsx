...
const teamData: Record<string, YearData> = {
  '2026-2027': {
    exec: [
      ...
      { name: 'Vivian Mao',             role: 'Vice President',                            photo: '/VivianMao.jpg',          linkedin: 'https://www.linkedin.com/in/vivianmao7/' },
      ...
      { name: 'Ryan Cortenbach',        role: 'Treasurer',                                 photo: '/RyanCortenbach2.png',    linkedin: 'https://www.linkedin.com/in/ryancortenbach/' },
      ...
      { name: 'Sophia Li',              role: 'Class Coordinator',                         photo: '/Sophia Li.jpg',          linkedin: 'https://www.linkedin.com/in/sophiiali/' },
      { name: 'Venice Chalermthanakom', role: 'Director of Community',                     photo: '/Venice.jpg',             linkedin: 'https://www.linkedin.com/in/venicevsc/' },
    ],
  },
  '2025-2026': {
    exec: [
